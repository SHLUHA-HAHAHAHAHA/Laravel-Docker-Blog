...
<main class="app-main">
    ...
    <div class="app-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{route("admin.category.update", $category->id)}}" class="col-4" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="mb-3">
                            <label for="inputTitle" class="form-label">Название</label>
                            <input type="text" name="title" class="form-control" id="inputTitle" value="{{$category->title}}">
                            @error('title')
